...
//        }
        ...
        crateHangulClock(hourData, hangulClockArr, changeHour);
        printHangulClock();
    }

    private void crateHangulClock(HourData[] hourData, String[][] hangulClockArr, int hour) {
